...
#ifndef UFO_FILTERS_OBSSTRINGFORMATTER_H_
#define UFO_FILTERS_OBSSTRINGFORMATTER_H_
...
class ObsStringFormatterParameters : public oops::Parameters {
 ...
 public:
  ...
  oops::RequiredParameter<std::vector<ObsStringFormatVariableParameters>> variables{"variables", this};
};
...
#endif // UFO_FILTERS_OBSSTRINGFORMATTER_H_
